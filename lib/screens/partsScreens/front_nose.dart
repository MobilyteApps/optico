...
class FrontNoseScreenState extends State<FrontNoseScreen> {
  List<PreForm> initTrailerFrontList;
  List<dynamic> trailerFrontList = List();
  FrontNoseScreenState(this.initTrailerFrontList);
  ...
  void initState() {
    super.initState();
    trailerFrontList.add("assets/front_nose.png");
    trailerFrontList.addAll(initTrailerFrontList);
  ...
  Widget build(BuildContext context) {
    ...
    return
      initTrailerFrontList == null? CircularProgressIndicator() :
      ListView.builder(
          shrinkWrap: true,
            ...
            return Column(
              children: <Widget>[
                index == 0 ? Padding(
                  ...
                  child: Image.asset(
                      trailerFrontList[index], width: width / 2, height: height / 6),
                ) :
                Card(
